...
hi Boolean      ctermfg=244   ctermbg=NONE cterm=NONE
...
hi Pmenu        ctermfg=244 ctermbg=232 cterm=NONE
hi PmenuSbar    ctermfg=07 ctermbg=09 cterm=NONE
hi PmenuSel     ctermfg=07 ctermbg=09 cterm=bold
hi PmenuThumb   ctermfg=07 ctermbg=09 cterm=NONE
...
hi StatusLine   ctermfg=244  ctermbg=NONE cterm=NONE
...
hi vimCommand      ctermfg=244 ctermbg=NONE cterm=NONE
hi vimComment      ctermfg=59  ctermbg=NONE cterm=NONE
hi vimCommentTitle ctermfg=59  ctermbg=NONE cterm=bold
hi vimFgBgAttrib   ctermfg=244 ctermbg=NONE cterm=NONE
hi vimFunc         ctermfg=244 ctermbg=NONE cterm=NONE
hi vimFuncName     ctermfg=244 ctermbg=NONE cterm=NONE
hi vimFuncSID      ctermfg=246 ctermbg=NONE cterm=NONE
hi vimFuncVar      ctermfg=244 ctermbg=NONE cterm=NONE
hi vimFunction     ctermfg=244 ctermbg=NONE cterm=NONE
hi vimGroup        ctermfg=246 ctermbg=NONE cterm=NONE
hi vimHiAttrib     ctermfg=244 ctermbg=NONE cterm=NONE
hi vimHiCterm      ctermfg=244 ctermbg=NONE cterm=NONE
hi vimHiCtermFgBg  ctermfg=246 ctermbg=NONE cterm=NONE
hi vimHiGroup      ctermfg=244 ctermbg=NONE cterm=NONE
hi vimHiKeyList    ctermfg=244 ctermbg=NONE cterm=NONE
hi vimHighlight    ctermfg=244 ctermbg=NONE cterm=NONE
hi vimHiNmbr       ctermfg=244 ctermbg=NONE cterm=NONE
...
hi vimOper         ctermfg=246 ctermbg=NONE cterm=NONE
hi vimOption       ctermfg=244 ctermbg=NONE cterm=NONE
hi vimParenSep     ctermfg=244 ctermbg=NONE cterm=NONE
hi vimSet          ctermfg=246 ctermbg=NONE cterm=NONE
hi vimSetEqual     ctermfg=246 ctermbg=NONE cterm=NONE
hi vimSetSep       ctermfg=59  ctermbg=NONE cterm=NONE
hi vimString       ctermfg=30  ctermbg=NONE cterm=NONE
hi vimSynType      ctermfg=244 ctermbg=NONE cterm=NONE
hi vimVar          ctermfg=244 ctermbg=NONE cterm=NONE
...
hi yamlBlockMappingKey          ctermfg=09 ctermbg=NONE cterm=NONE
...
hi pythonConditional ctermfg=09  ctermbg=NONE cterm=NONE
hi pythonDecorator   ctermfg=244 ctermbg=NONE cterm=NONE
hi pythonDottedName  ctermfg=244 ctermbg=NONE cterm=NONE
hi pythonException   ctermfg=09  ctermbg=NONE cterm=NONE
hi pythonFloat       ctermfg=09  ctermbg=NONE cterm=NONE
hi pythonFunction    ctermfg=244 ctermbg=NONE cterm=NONE
hi pythonImport      ctermfg=244 ctermbg=NONE cterm=NONE
hi pythonImport      ctermfg=09  ctermbg=NONE cterm=NONE
hi pythonNumber      ctermfg=09  ctermbg=NONE cterm=NONE
hi pythonOperator    ctermfg=09  ctermbg=NONE cterm=NONE
hi pythonStatement   ctermfg=09  ctermbg=NONE cterm=NONE
hi pythonString      ctermfg=09  ctermbg=NONE cterm=NONE
